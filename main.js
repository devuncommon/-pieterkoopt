...
const pageScripts = {
  ...
  howitworks: function () {
    console.log("🛠️ How it works animaties gestart.");
    ...
    // Voeg hier je How-it-works pagina GSAP scripts toe
    if (window.innerWidth > 991) {
      ScrollTrigger.create({
        trigger: ".usp-cards-section",
        start: "top top",
      ...
      // Jouw extra GSAP scripts voor How it Works hier...
    }
  }
};
...
function runPageScripts() {
  ...
  if (pageScripts[page]) {
    ...
    console.log(`Geen scripts voor pagina: ${page}`);
  }
}
